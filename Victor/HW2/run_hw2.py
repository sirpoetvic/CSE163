...
No need to provide your name information here.
"""
...
def part0():
    ...
    print(
        "Average attack for fire types", hw2_manual.mean_attack_for_type(data, "fire")
    )
...
def part1():
    ...
    print(
        "Average attack for fire types", hw2_pandas.mean_attack_for_type(data, "fire")
    )
    print("Count of each Pokemon type:")
